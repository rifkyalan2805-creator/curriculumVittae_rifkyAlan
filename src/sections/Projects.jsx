...
const projects = [
  {
    ...
    desc: 'Full-stack e-commerce dengan fitur cart, payment gateway Midtrans, admin dashboard, dan real-time order tracking.',
  ...
  },
  {
    ...
    desc: 'Aplikasi manajemen tugas dengan drag & drop, kolaborasi tim real-time, dan notifikasi push berbasis PWA.',
  ...
  },
  {
    id: 4,
    title: 'REST API Blog',
    desc: 'Backend API untuk platform blog dengan autentikasi JWT, CRUD artikel, komentar, dan upload gambar ke Cloudinary.',
